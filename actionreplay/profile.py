...
STATUSES = {
    ...
    "INVALID_MEMBER_DRAFT": ("Invalid member draft", "business_outcome"),
    "MEMBER_ALREADY_EXISTS": ("Member already exists", "business_outcome"),
    "INVALID_NICKNAME": ("Invalid nickname", "business_outcome"),
    "INVALID_AMOUNT": ("Invalid amount", "business_outcome"),
    "INSUFFICIENT_FUNDS": ("Insufficient funds", "business_outcome"),
    "INVALID_ACCOUNT_COMBINATION": ("Invalid account combination", "business_outcome"),
